...
import com.ruoyi.workflow.mapper.WfRunTaskMapper;
...
public class WfProcessServiceImpl extends FlowServiceFactory implements IWfProcessService {
    ...
    private final WfRunTaskMapper wfRunTaskMapper;
...
//        result.put("finished",true);
    ...
    private void startProcess(ProcessDefinition procDef, Map<String, Object> variables) {
        ...
        log.info("当前用户id:{}", userIdStr);
        log.info("当前流程实例id:{}", processInstance.getProcessInstanceId());
        log.info("打印当前的taskList==================");
        log.info("taskList:{}", taskList);
        List<WfTaskVo> wfTaskVos = wfRunTaskMapper.selectRunTaskList(processInstance.getProcessInstanceId());
        log.info("打印wfTaskVos：{}", wfTaskVos);
    }
